...
-- Map <leader>p to paste without overwriting the default register
...
-- Remap Ctrl+d and Ctrl+u to scroll and center the screen
vim.api.nvim_set_keymap("n", "<C-d>", "<C-d>zz", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "<C-u>", "<C-u>zz", { noremap = true, silent = true })

-- Remap n and N to search and center the screen
vim.api.nvim_set_keymap("n", "n", "nzzzv", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "N", "Nzzzv", { noremap = true, silent = true })

-- Insert mode exit remaps
...
-- Remap >> and << to prevent entering insert mode
...
require("lazy").setup({
	...
	-- 	"tpope/vim-fugitive",
	-- 	config = function()
	-- 		-- Optional configuration or key mappings can go here
	-- 	end,
	-- },
	...
	{ -- Autoformat
		...
		opts = {
			...
			format_on_save = function(bufnr)
				...
				-- Enable formatting for other files
